...
int main(int argc, char **argv) {
	...
	while (1)
	{
		...
		if (ev.type == ALLEGRO_EVENT_TIMER) {
			if (bouncer_x < 10 || bouncer_x > SCREEN_W - BOUNCER_SIZE) {
				bouncer_dx = -bouncer_dx;
			}

			if (bouncer_y < 10 || bouncer_y > SCREEN_H - BOUNCER_SIZE) {
			...
			bouncer_x = 250 + 15 * (56 * cos(t) - 48 * cos(2.3*t));
			bouncer_y = 251 + 15 * (28 * sin(t) - 24 * sin(2.1*t));
			/////////////////////////////////////////////////////////////////////////////////////////////////////
			redraw = true;
		}
